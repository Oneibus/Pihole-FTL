...
static struct {
	...
	{ "/api/client_groups:batchDelete",         "",                           api_client_groups,                     { API_PARSE_JSON | API_BATCHDELETE, 0       }, true,  HTTP_POST },
	{ "/api/client_groups",                     "/{client_id}/{group_id}",    api_client_groups,                     { API_PARSE_JSON, 0                         }, true,  HTTP_DELETE },
	{ "/api/client_groups",                     "/{client_id}",               api_client_groups,                     { API_PARSE_JSON, 0                         }, true,  HTTP_GET | HTTP_PUT },
	{ "/api/client_groups",                     "",                           api_client_groups,                     { API_PARSE_JSON, 0                         }, true,  HTTP_GET | HTTP_POST },
	...
	{ "/api/groups/empty",                      "",                           api_groups_util,                       { API_PARSE_JSON, 0                         }, true,  HTTP_GET },
	{ "/api/groups",                            "",                           api_list,                              { API_PARSE_JSON, 0                         }, true,  HTTP_GET | HTTP_POST },
	{ "/api/groups",                            "/{group_id}/status",         api_groups_util,                       { API_PARSE_JSON, 0                         }, true,  HTTP_GET },
	{ "/api/groups",                            "/{group_id}/force",          api_groups_util,                       { API_PARSE_JSON, 0                         }, true,  HTTP_DELETE },
